...
package net.mcreator.bespin.gui;
...
public class GuiDataInfo extends ElementsBespin.ModElement {
	public static int GUIID = 2;
	public static HashMap guistate = new HashMap();
	public GuiDataInfo(ElementsBespin instance) {
		super(instance, 68);
	}
	...
	public static class GuiContainerMod extends Container implements Supplier<Map<Integer, Slot>> {
		...
		public GuiContainerMod(World world, int x, int y, int z, EntityPlayer player) {
			...
			this.customSlots.put(0, this.addSlotToContainer(new Slot(internal, 0, 297, 174) {
			}));
			int si;
			int sj;
			for (si = 0; si < 3; ++si)
				for (sj = 0; sj < 9; ++sj)
					this.addSlotToContainer(new Slot(player.inventory, sj + (si + 1) * 9, 122 + 8 + sj * 18, 33 + 84 + si * 18));
			for (si = 0; si < 9; ++si)
				this.addSlotToContainer(new Slot(player.inventory, si, 122 + 8 + si * 18, 33 + 142));
		}
		...
		private void slotChanged(int slotid, int ctype, int meta) {
			if (this.world != null && this.world.isRemote) {
				Bespin.PACKET_HANDLER.sendToServer(new GUISlotChangedMessage(slotid, x, y, z, ctype, meta));
	...
	public static class GuiWindow extends GuiContainer {
		...
		private static final ResourceLocation texture = new ResourceLocation("bespin:textures/datainfo.png");
		@Override
		...
		protected void drawGuiContainerForegroundLayer(int par1, int par2) {
			this.fontRenderer.drawString("equiped", 5, 4, -10066330);
		}
		...
		protected void actionPerformed(GuiButton button) {
			Bespin.PACKET_HANDLER.sendToServer(new GUIButtonPressedMessage(button.id, x, y, z));
