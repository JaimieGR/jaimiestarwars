...
package net.mcreator.bespin.keybind;
...
import net.mcreator.bespin.procedure.ProcedureOpenData;
import net.mcreator.bespin.ElementsBespin;
import net.mcreator.bespin.Bespin;

@ElementsBespin.ModElement.Tag
public class KeyBindingOpenEquipment extends ElementsBespin.ModElement {
	private KeyBinding keys;
	public KeyBindingOpenEquipment(ElementsBespin instance) {
		super(instance, 69);
	}
	...
	public void init(FMLInitializationEvent event) {
		keys = new KeyBinding("key.mcreator.openequipment", Keyboard.KEY_R, "key.categories.misc");
	...
	public void onKeyInput(InputEvent.KeyInputEvent event) {
		if (Minecraft.getMinecraft().currentScreen == null) {
			if (org.lwjgl.input.Keyboard.isKeyDown(keys.getKeyCode())) {
				Bespin.PACKET_HANDLER.sendToServer(new KeyBindingPressedMessage());
	...
	private static void pressAction(EntityPlayer entity) {
			...
			return;
		{
			...
			ProcedureOpenData.executeProcedure($_dependencies);
		}
	}
}
