...
import net.mcreator.bespin.item.ItemHoth;
...
public class WorldHoth extends ElementsBespin.ModElement {
	public static int DIMID = 4;
	public static final boolean NETHER_TYPE = false;
	@GameRegistry.ObjectHolder("bespin:hoth_portal")
	public static final BlockCustomPortal portal = null;
	public static DimensionType dtype;
	public WorldHoth(ElementsBespin instance) {
		super(instance, 3);
	}
	...
	public void initElements() {
		...
		elements.items.add(() -> new ItemHoth().setUnlocalizedName("hoth").setRegistryName("hoth"));
	}
	...
	public void preInit(FMLPreInitializationEvent event) {
		if (DimensionManager.isDimensionRegistered(DIMID)) {
			...
			System.err.println("Dimension ID for dimension hoth is already registered. Falling back to ID: " + DIMID);
		}
		dtype = DimensionType.register("hoth", "_hoth", DIMID, WorldProviderMod.class, true);
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(ItemHoth.block, 0, new ModelResourceLocation("bespin:hoth", "inventory"));
	}
	...
	public static class BlockCustomPortal extends BlockPortal {
		public BlockCustomPortal() {
			setHardness(-1.0F);
			setUnlocalizedName("hoth_portal");
			setRegistryName("hoth_portal");
			setLightLevel(0F);
		}
	...
	public static class ChunkProviderModded implements IChunkGenerator {
		...
		private static final IBlockState STONE2 = Blocks.PACKED_ICE.getDefaultState();
		private static final IBlockState FLUID = Blocks.SNOW.getDefaultState();
	...
	public static class GenLayerBiomesCustom extends GenLayer {
		private Biome[] allowedBiomes = {Biome.REGISTRY.getObject(new ResourceLocation("bespin:hothflat")),};
