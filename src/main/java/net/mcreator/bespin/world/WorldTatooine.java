...
import net.mcreator.bespin.item.ItemTatooine;
...
public class WorldTatooine extends ElementsBespin.ModElement {
	public static int DIMID = 5;
	public static final boolean NETHER_TYPE = false;
	@GameRegistry.ObjectHolder("bespin:tatooine_portal")
	public static final BlockCustomPortal portal = null;
	public static DimensionType dtype;
	public WorldTatooine(ElementsBespin instance) {
		super(instance, 13);
	}
	...
	public void initElements() {
		...
		elements.items.add(() -> new ItemTatooine().setUnlocalizedName("tatooine").setRegistryName("tatooine"));
	}
	...
	public void preInit(FMLPreInitializationEvent event) {
		if (DimensionManager.isDimensionRegistered(DIMID)) {
			...
			System.err.println("Dimension ID for dimension tatooine is already registered. Falling back to ID: " + DIMID);
		}
		dtype = DimensionType.register("tatooine", "_tatooine", DIMID, WorldProviderMod.class, true);
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(ItemTatooine.block, 0, new ModelResourceLocation("bespin:tatooine", "inventory"));
	}
	...
	public static class BlockCustomPortal extends BlockPortal {
		public BlockCustomPortal() {
			setHardness(-1.0F);
			setUnlocalizedName("tatooine_portal");
			setRegistryName("tatooine_portal");
			setLightLevel(0F);
		}
	...
	public static class ChunkProviderModded implements IChunkGenerator {
		...
		private static final IBlockState FLUID = Blocks.SAND.getStateFromMeta(0);
	...
	public static class GenLayerBiomesCustom extends GenLayer {
		private Biome[] allowedBiomes = {Biome.REGISTRY.getObject(new ResourceLocation("bespin:tatflat")),};
