...
package net.mcreator.bespin.world;
...
import net.mcreator.bespin.item.ItemVoidtest;
...
public class WorldVoidtest extends ElementsBespin.ModElement {
	public static int DIMID = 3;
	public static final boolean NETHER_TYPE = false;
	@GameRegistry.ObjectHolder("bespin:voidtest_portal")
	public static final BlockCustomPortal portal = null;
	public static DimensionType dtype;
	public WorldVoidtest(ElementsBespin instance) {
		super(instance, 1);
	}
	...
	public void initElements() {
		...
		elements.items.add(() -> new ItemVoidtest().setUnlocalizedName("voidtest").setRegistryName("voidtest"));
	}
	...
	public void preInit(FMLPreInitializationEvent event) {
		if (DimensionManager.isDimensionRegistered(DIMID)) {
			...
			System.err.println("Dimension ID for dimension voidtest is already registered. Falling back to ID: " + DIMID);
		}
		dtype = DimensionType.register("voidtest", "_voidtest", DIMID, WorldProviderMod.class, true);
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(ItemVoidtest.block, 0, new ModelResourceLocation("bespin:voidtest", "inventory"));
	}
				...
				for (int l8 = 0; l8 < 4; ++l8) {
					for (int l9 = -1; l9 < 4; ++l9) {
						...
						this.world.setBlockState(new BlockPos(l10, l11, k12),
								flag1 ? Blocks.LAPIS_BLOCK.getDefaultState().getBlock().getDefaultState() : iblockstate, 2);
					}
				}
	...
	public static class BlockCustomPortal extends BlockPortal {
		public BlockCustomPortal() {
			setHardness(-1.0F);
			setUnlocalizedName("voidtest_portal");
			setRegistryName("voidtest_portal");
			setLightLevel(0F);
		}
		...
		public static class Size {
			...
			protected int getDistanceUntilEdge(BlockPos p_180120_1_, EnumFacing p_180120_2_) {
				...
				return block == Blocks.LAPIS_BLOCK.getDefaultState().getBlock() ? i : 0;
			}
				...
				label56 : for (this.height = 0; this.height < 21; ++this.height) {
					for (int i = 0; i < this.width; ++i) {
						...
						if (i == 0) {
							...
							if (block != Blocks.LAPIS_BLOCK.getDefaultState().getBlock()) {
								break label56;
							}
	...
	public static class GenLayerBiomesCustom extends GenLayer {
		private Biome[] allowedBiomes = {Biome.REGISTRY.getObject(new ResourceLocation("bespin:sky")),};
